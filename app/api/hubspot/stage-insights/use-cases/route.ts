...
export async function GET(request: Request) {
  try {
    ...
    const backendUrl = `${rootUrl}/api/hubspot/stage-insights/use-cases?stage=${encodeURIComponent(stage)}&start_date=${start_date}&end_date=${end_date}`;
    ...
    console.error('Error in stage-insights use-cases route:', error);
    return NextResponse.json(
