                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Deal</p>
                      <p className="text-sm font-medium text-gray-900 dark:text-white truncate">{selectedMeeting.deal_id}</p>
                    </div>
                  </div>
